...
import com.javacourse.mongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		CommentDTO comment1  = new CommentDTO("Boa viagem mano!", dtFormat.parse("21/03/2018"), new AuthorDTO(alex));
		CommentDTO comment2  = new CommentDTO("Aproveite", dtFormat.parse("22/03/2018"), new AuthorDTO(bob));
		CommentDTO comment3  = new CommentDTO("Tenha um ótimo dia", dtFormat.parse("23/03/2018"), new AuthorDTO(alex));
